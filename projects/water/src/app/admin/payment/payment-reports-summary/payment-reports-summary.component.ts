...
@Component({
  selector: 'app-payment-reports-summary',
  templateUrl: './payment-reports-summary.component.html',
  styleUrls: ['./payment-reports-summary.component.css']
})
export class PaymentReportsSummaryComponent {
